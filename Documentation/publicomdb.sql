...
CREATE TABLE IF NOT EXISTS `message` (
  ...
  'ID_MESSAGE_PUBLICITAIRE' INTEGER NULL,
  'date_Limite' Time NULL,
  PRIMARY KEY (`ID`),
...
CREATE  INDEX I_FK_MESSAGE_COMMERCANT
     ON MESSAGE (ID_MESSAGE_PUBLICITAIRE ASC);
--
...
ALTER TABLE MESSAGE 
  ADD FOREIGN KEY FK_MESSAGE_COMMERCANT (ID_MESSAGE_PUBLICITAIRE)
